...
export default function UserDashboard() {
 ...
 <div><p className="opacity-60 mb-0.5 font-bold text-lg">Points</p><p>{loyalty?.total_points || 0}</p></div>
 <div><p className="opacity-60 mb-0.5 font-bold text-lg">Discount</p><p>{membership?.discount_percent || 0}%</p></div>
 {membership?.next_tier && <div><p className="opacity-60 mb-0.5 font-bold text-lg capitalize">Next Tier</p><p>{membership.next_tier}</p></div>}
 </div>
 </div>
 </motion.div>
 ...
 <div className="w-20 h-20 rounded-lg qr-pulse flex items-center justify-center bg-[var(--color-bg-tertiary)] border border-[var(--color-border-subtle)]">
