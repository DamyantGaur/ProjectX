        ...
        <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                    <button
                        onClick={() => { setShowCreateForm(!showCreateForm); setCreateMsg({ type: '', text: '' }); }}
            ...
            {showCreateForm && (
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="mb-8">
                    <div className="glass-card" style={{ padding: '28px' }}>
                        ...
                        {createMsg.text && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-4 p-3 rounded-xl flex items-center gap-2 text-sm" style={{
                                background: createMsg.type === 'success' ? 'rgba(91,154,111,0.08)' : 'rgba(192,96,112,0.08)',
                                border: `1px solid ${createMsg.type === 'success' ? 'rgba(91,154,111,0.2)' : 'rgba(192,96,112,0.2)'}`,
                                color: createMsg.type === 'success' ? '#5B9A6F' : '#C06070',
                            }}>
