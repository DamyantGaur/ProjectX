...
export default function AdminPayments() {
 ...
 <tbody>
 {filtered.map((p, i) => (
 <motion.tr key={p.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.03 }} className="border-b border-[var(--color-border-subtle)] hover:bg-white/[0.02] transition-colors">
