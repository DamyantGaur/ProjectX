    ...
    return (
        <div  className="min-h-screen bg-[var(--color-bg-primary)] flex items-center justify-center px-4 py-12">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-1/4 left-1/4 w-80 h-80 rounded-full" className="absolute top-1/4 left-1/4 w-80 h-80 rounded-full bg-[var(--color-accent-gold)]/10 blur-[100px]" />
                <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full" className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-[var(--color-accent-lavender)]/10 blur-[100px]" />
            </div>
            ...
            >
                ...
                <motion.div className="text-center mb-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
                    <Link to="/" className="inline-flex items-center gap-2">
                        ...
                        <h1 className="accent-text" className="text-2xl font-bold accent-text tracking-tight">PROJECT X</h1>
                    </Link>
                ...
                <div className="glass-card neon-glow">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button id="login-submit" type="submit" disabled={loading} className="btn-primary" className="btn-primary w-full flex items-center justify-center gap-2">
                            {loading ? (
